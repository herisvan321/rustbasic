...
async fn main() {
    ...
    // 6. Setup Session dengan Custom Store
    ...
    tracing::info!("Session aktif menggunakan driver: {} (Laravel Schema)", cfg.session_driver);

    // 7. Setup Folder Publik (untuk CSS/JS/Gambar)
    let static_files = ServeDir::new("public");

    // 8. Gabungkan Rute dan Jalankan Server
    let app = Router::new()
